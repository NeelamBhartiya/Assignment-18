...
#DataSet
cs2m <- read.csv("C:\\Users\\Windows 10\\Desktop\Neelam_ACADGILD\\Assignment\\cs2m.csv")
View(cs2m)
...
#our accuracy of model is 0.8225949
#also by seeing various measures like ME,RSS,RMSE,MAPE of our tree which is good
#by all these things we conclude that the model is good and fit